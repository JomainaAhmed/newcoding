#Python Program to create a repository of my classmates' names and mobile numbers and search it out from the repository

# this function will contain the repository
def initial_repository():
    phone_book = [["Khushboo Yadav", 6306450948], ["Dona Dutta", 9832998537], ["Arghya Dutta", 6296912074], ["Anirban Roy", 1234567890],["Rohan Chakraborty", 9876543210], ["Esha Dey", 9832906230]]
